...
passwords = driver.find_element(By.XPATH, value='//*[@id="pass"]')
...
for n in range(100):
    ...
    try:
        print("called")
        like_button = driver.find_element(By.XPATH, value='//button[@class="button Lts($ls-s) Z(0) CenterAlign Mx(a) Cur(p) Tt(u) Bdrs(50%) P(0) Fw($semibold) focus-button-style Bxsh($bxsh-btn) Expand Trstf(e) Trsdu($normal) Wc($transform) Pe(a) Scale(1.1):h Scale(.9):a Bgi($g-ds-background-like):a"]')
        like_button.click()
